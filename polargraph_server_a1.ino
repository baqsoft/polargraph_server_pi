...
const static String CMD_PWMOFF = "C80";
const static String CMD_PWMON = "C81";
const static String CMD_SETTHRUST = "C82";
const static String CMD_HOMING = "C83";
const static String CMD_CHANGELENGTAHEAD = "C84";
...
void setup() 
{
  ...
  // limit switches config
  pinMode(LIMIT_SWITCH_1_PIN, INPUT_PULLUP);
  pinMode(LIMIT_SWITCH_2_PIN, INPUT_PULLUP);
  limitSwitch1 = digitalRead(LIMIT_SWITCH_1_PIN);
  limitSwitch2 = digitalRead(LIMIT_SWITCH_2_PIN);
